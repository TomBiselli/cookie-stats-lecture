...
# ── 3. DESCRIPTIVE STATISTICS ─────Break before, 1 slide further !────────────
...
# PPA: mean = 76,  median = 65   
# PA:  mean = 99,  median = 65  
# CG:  mean = 173, median = 231  
...
# ============================================================
# SECTION 6 — INFERENCE STATISTICS + R (proceed with Slides before!)
# ============================================================
...
# ── 8. INDEPENDENT SAMPLES T-TEST ──────SLIDES FIRST!────────────
...
# QQ Plot to substantiate distribution assumptions
ggplot(df_gender, aes(sample = sus_score)) +
  stat_qq() +
  stat_qq_line(colour = "red") +
  facet_wrap(~gender) +
  labs(
    title = "Q-Q Plots — SUS Score by Gender",
...
# Check normaility with QQ Plot
ggplot(df, aes(sample = ati_score)) +
  stat_qq() +
  stat_qq_line(colour = "red") +
  facet_wrap(~edu3) +
  labs(
    title = "Q-Q Plots — ATI Score by Education Level",
    x = "Theoretical quantiles",
    y = "Sample quantiles"
  ) +
  theme_minimal()
...
# Interpret:
# PPA vs PA:  Z = 2.15,  p = .03,   r ≈ .21  (small-medium)
# PPA vs CG:  Z = 6.52,  p < .001,  r ≈ .63  (large)
# PA  vs CG:  Z = 4.20,  p < .001,  r ≈ .42  (medium)
# r conventions: small = .1, medium = .3, large = .5


# ============================================================
# SECTION 7 — REPORTING (GO BACK TO SLIDES FIRST)
# ============================================================
